...
{application,stdlib,
             [{description,"ERTS  CXC 138 10"},
              ...
              {modules,[array,base64,beam_lib,binary,c,calendar,dets,
                        ...
                        digraph,digraph_utils,edlin,edlin_expand,epp,erl_anno,
                        ...
                        error_logger_tty_h,escript,ets,eval_bits,file_sorter,
                        filelib,filename,gb_sets,gb_trees,gen,gen_event,
                        gen_fsm,gen_server,io,io_lib,io_lib_format,
